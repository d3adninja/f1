  ...
  <div class="container py-5">
    <div class="row g-3 align-items-center">
      <div class="col-lg-6 text-center text-lg-start">
        <h1 class="display-1 mb-0 animated slideInLeft">AMC Services</h1>
      </div>
      <div class="col-lg-6 animated slideInRight">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb justify-content-center justify-content-lg-end mb-0">
            ...
            <li class="breadcrumb-item text-secondary active" aria-current="page">AMC Services</li>
          </ol>
        </nav>
      </div>
    </div>
...
<div class="container-fluid py-5" style="background-color:#d3d3d3;">
  <div class="container">
    <div class="text-center mb-5">
      <h1>
        <span class="text-uppercase  text-white bg-dark px-2">AMC Services</span>
        by F1 Infotech
      </h1>
    </div>
    <div class="row g-5 align-items-center">
      <div class="col-lg-6">
        <img src="img/amcservices.jpg" class="img-fluid rounded shadow" alt="AMC Services">
      </div>
      <div class="col-lg-6">
        <h3 class="fw-bold mb-3">Reliable IT upkeep, so your business never slows down.</h3>
        <p class="mb-3">
          At F1 InfoTech, we understand how critical it is to keep IT systems performing at their best.
          Our AMC services go beyond simple maintenance—we proactively monitor, update, and optimize your
          infrastructure to prevent issues before they arise. From servers and storage to networking and
          end-user devices, we ensure your IT backbone stays resilient, secure, and future-ready.
        </p>
        <p class="mb-3">
          With decades of experience across industries, we tailor AMC models to fit the specific needs
          of enterprises, government agencies, and institutions, ensuring maximum uptime and reduced
          operational risks.
        </p>
      </div>
    </div>
...
<div class="container-fluid py-5" style="background: linear-gradient(135deg, #eef7ff, #ffffff);">
  <div class="container">
    <div class="text-center mb-5">
      ...
      <p class="text-muted">Common hurdles businesses face in maintaining IT infrastructure</p>
    </div>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-6 col-lg-3">
        <div class="challenge-card h-100 text-center p-4">
          ...
          <h5 class="fw-bold">Rising Downtime Risks</h5>
          <p class="small">Frequent system breakdowns causing costly downtime and disruptions.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="challenge-card h-100 text-center p-4">
          ...
          <h5 class="fw-bold">Escalating IT Maintenance Costs</h5>
          <p class="small">High repair and replacement costs strain budgets.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="challenge-card h-100 text-center p-4">
          ...
          <h5 class="fw-bold">Lack of Preventive Care</h5>
          <p class="small">Limited timely updates and preventive maintenance increase risks.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="challenge-card h-100 text-center p-4">
          ...
          <h5 class="fw-bold">Vendor Coordination Hassles</h5>
          <p class="small">Lack of in-house expertise complicates IT asset management.</p>
        </div>
      </div>
    </div>
  </div>
