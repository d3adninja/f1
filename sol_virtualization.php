  ...
  <div class="container py-5">
    <div class="row g-3 align-items-center">
      <div class="col-lg-6 text-center text-lg-start">
        <h1 class="display-1 mb-0 animated slideInLeft">Virtualization</h1>
      ...
      <div class="col-lg-6 animated slideInRight">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb justify-content-center justify-content-lg-end mb-0">
            ...
            <li class="breadcrumb-item text-secondary active" aria-current="page">Virtualization</li>
          </ol>
        </nav>
      </div>
    </div>
...
<div class="container-fluid py-5" style="background-color:#eef7ff;">
  <div class="container">
    ...
    <div class="row g-5 align-items-center">
      <div class="col-lg-6">
        <img src="img/virtualization.jpg" class="img-fluid rounded shadow" alt="Virtualization">
      </div>
      <div class="col-lg-6">
            <h3 class="fw-bold mb-3">Do more with less—virtualize your IT for efficiency and growth.</h3>
            <p class="mb-3">
          With our Virtualization solutions we help businesses simplify their IT setup by running multiple
            systems on a single infrastructure. From servers and storage to desktops, applications, and
            networks — virtualization ensures efficient resource usage, cost savings, and a smooth move to
            cloud computing.
...
<div class="container-fluid py-5" style="background: linear-gradient(135deg, #eef7ff, #ffffff);">
  <div class="container">
    <div class="text-center mb-5">
      ...
      <p class="text-muted">Major hurdles businesses face before adopting virtualization</p>
    </div>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-6 col-lg-3">
        <div class="challenge-card h-100 text-center p-4">
          ...
          <h5 class="fw-bold">High IT Costs</h5>
          <p class="small">Underutilized hardware and inefficient infrastructure drive expenses up.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="challenge-card h-100 text-center p-4">
          ...
          <h5 class="fw-bold">Complex, Rigid Systems</h5>
          <p class="small">Siloed setups make operations slow and limit flexibility.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="challenge-card h-100 text-center p-4">
          ...
          <p class="small">Businesses struggle to quickly adjust resources with changing demand.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="challenge-card h-100 text-center p-4">
          ...
          <h5 class="fw-bold">Downtime &amp; Overheads</h5>
          <p class="small">Frequent disruptions and high upkeep affect performance.</p>
        </div>
      </div>
    </div>
  </div>
