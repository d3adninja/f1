...
<!-- Footer Start -->
<!-- Footer Start -->
<div class="container-fluid footer pt-5" style="background-color: #000000; color: #ffffff;">

  <style>
    /* Ensure all footer text is white */
    .footer, .footer p, .footer a, .footer h1, .footer h5 {
      color: #ffffff !important;
    }

    /* Footer links (services, who we serve) */
    .footer .btn-link {
      color: #ffffff !important;
    ...
    .footer .btn-link:hover {
      color: #cccccc !important; /* softer white on hover */
    }
    ...
    .footer .btn-outline-primary:hover {
      ...
      color: #006699 !important; /* invert for contrast */
    }
  ...
  <div class="container py-5">
    ...
    <a href="index.html" class="d-inline-block mb-3">
        <img src="img/f1logo1.png" alt="F1 Infotech Logo" style="max-width: 100%; height: auto;">
    </a>
    <p class="mb-0">
      ...
      <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
        ...
        <p><i class="fa fa-map-marker-alt me-3"></i>Address: F1 Infotech Pvt. Ltd. C-160, IInd Floor, MayaPuri Industrial Phase-II, New Delhi-110064.</p>
        <p><i class="fa fa-phone-alt me-3"></i>Phone: +011 499 685 67</p>
        <p><i class="fa fa-envelope me-3"></i>Email: support@f1infotech.com</p>
        <p><i class="fa fa-share-alt me-3"></i>Follow us on:</p>
      ...
      <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.7s">
        ...
        <a class="btn btn-link" href="">Banking</a>
        <a class="btn btn-link" href="">Finance</a>
        <a class="btn btn-link" href="">Enterprises</a>
        <a class="btn btn-link" href="">Health Care</a>
        <a class="btn btn-link" href="">Start ups</a>
        <a class="btn btn-link" href="">Public & Government Sector</a>
        <a class="btn btn-link" href="">Consumer Goods</a>
    ...
    <div class="copyright">
      <div class="row">
        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
          &copy; <a class="border-bottom" href="#">F1 Infotech pvt ltd</a>, All Right Reserved.<br>
