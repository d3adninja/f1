  ...
  <div class="container py-5">
    <div class="row g-3 align-items-center">
      <div class="col-lg-6 text-center text-lg-start">
        <h1 class="display-1 mb-0 animated slideInLeft">Internet of Things (IoT)</h1>
      </div>
      <div class="col-lg-6 animated slideInRight">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb justify-content-center justify-content-lg-end mb-0">
            ...
            <li class="breadcrumb-item text-secondary active" aria-current="page">IoT</li>
          </ol>
        </nav>
      </div>
    </div>
...
<div class="container-fluid py-5" style="background-color:#eef7ff;">
  <div class="container">
    ...
    <div class="row g-5 align-items-center">
      <div class="col-lg-6">
        <img src="img/IOT.jpg" class="img-fluid rounded shadow" alt="IoT Solutions">
      </div>
      <div class="col-lg-6">
        <h3 class="fw-bold mb-3">Connecting devices, creating possibilities.</h3>
        <p class="mb-3">
          At F1 InfoTech, our IoT solutions help businesses harness the power of connected devices to
          gather real-time insights, automate processes, and improve decision-making. From smart
          infrastructure to connected workplaces and industry automation, IoT bridges the gap between
          the physical and digital worlds for smarter, data-driven outcomes.
        </p>
      </div>
    </div>
  </div>
...
<div class="container-fluid py-5" style="background: linear-gradient(135deg, #eef7ff, #ffffff);">
  <div class="container">
    <div class="text-center mb-5">
      ...
      <p class="text-muted">Barriers organizations face when adopting IoT solutions</p>
    </div>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-6 col-lg-3">
        <div class="challenge-card h-100 text-center p-4">
          ...
          <h5 class="fw-bold">Data Overload</h5>
          <p class="small">Massive amounts of unstructured data make it hard to extract insights.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="challenge-card h-100 text-center p-4">
          ...
          <h5 class="fw-bold">Security Risks</h5>
          <p class="small">Connected devices create new entry points for cyberattacks.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="challenge-card h-100 text-center p-4">
          ...
          <h5 class="fw-bold">Integration Complexity</h5>
          <p class="small">Bringing together legacy systems and modern IoT devices is a major hurdle.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="challenge-card h-100 text-center p-4">
          ...
          <h5 class="fw-bold">Scalability Concerns</h5>
          <p class="small">Managing thousands of devices seamlessly requires robust infrastructure.</p>
        </div>
      </div>
    </div>
  </div>
